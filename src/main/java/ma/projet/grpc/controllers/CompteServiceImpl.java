...
/**
 * Implémentation du service gRPC CompteService
 * Cette classe gère les opérations CRUD sur les comptes bancaires
 */
@GrpcService
public class CompteServiceImpl extends CompteServiceGrpc.CompteServiceImplBase {
    ...
    public void compteById(GetCompteByIdRequest request, StreamObserver<GetCompteByIdResponse> responseObserver) {
        ...
        if (compte != null) {
            ...
            responseObserver.onError(new RuntimeException("Compte non trouvé avec ID: " + request.getId()));
        }
        responseObserver.onCompleted();
    }

    /**
     * Calcule les statistiques de solde
     */
    @Override
